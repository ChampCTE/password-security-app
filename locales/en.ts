...
export const en = {
  ...
  analyzerExposure: "Password exposure",
  analyzerExposureFound: "This password has been found in known data breaches.",
  analyzerExposureSafe: "No known exposure detected.",
  analyzerExposureCount: "This password has appeared {count} times in known data breaches. It is strongly recommended not to use it.",
  analyzerExposureSafeDescription: "This password was not found in the Have I Been Pwned password database.",
